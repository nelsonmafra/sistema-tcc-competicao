...
| **Jogos** | **▶ Ao vivo** — marcação ponto a ponto da arquibancada, com placar (games, tiebreak, match tiebreak, no-ad) calculado sozinho e classificação de cada ponto (ace, winner, erro forçado, erro não forçado, dupla falta). **👁 Acompanhar** — qualquer pessoa logada assiste à partida ao vivo, de outro aparelho, sem nenhum botão que grave; inclui **placar grande** em tela cheia, para tablet ou TV na sede. **+ Resultado** — registro rápido de jogo encerrado. **⇪ Importar** — planilha `.xlsx`/`.csv` ou colagem do Excel. |
